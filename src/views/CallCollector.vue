...
export default {
  ...
  methods: {
    ...
    filterByDates () {
      this.getData('/sim/get_all_call/', 'data', this.filter)
    },
  ...
  beforeMount () {
    ...
    this.getData('/sim/get_all_call/', 'data', {'start': date.formatDate(f_start, 'YYYY-MM-DD HH:mm:ss'), 'end': date.formatDate(f_end, 'YYYY-MM-DD') + ' 23:59:59'})
  }
}
</script>
<style scoped>
